...
\title[NN for automatic fog detection]{Neural network approach for automatic fog detection using surveillance camera images}
%\Subtitletrue
%\subtitle{abc}
\date{April 9, 2018}
\author[Pagani, Noteboom and Wauben]{Pagani, Noteboom and Wauben}
...
\begin{frame}
 ...
 \begin{tiny}
 \textit{EGU 2018 - Big data and machine learning in geosciences session
 April 9, 2018}
 \end{tiny}
 \end{textblock*}
\end{frame}
...
\begin{center}
\includegraphics[width=3cm]{private/original1.png}\\
\includegraphics[width=3cm]{private/resize1.png}\\
\includegraphics[width=3cm]{private/blurr1.png}
\end{center}
\end{textblock*}
...
\begin{textblock*}{4.8cm}(7.5cm,2cm)
 <<confusionExplanation, echo=FALSE, fig.height=3, fig.width=6>>=
