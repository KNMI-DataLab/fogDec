...
tempDewPointTwente <- ReadHumidityData("inst/extdata/Sensor/TwenteTemp_DewPoint1-1-2015-31-08-2016.csv")
...
```{r}
dataTwente <- dataTwente[windTwente, nomatch = 0]
dataTwente <- dataTwente[humidityTwente, nomatch = 0]
dataTwente <- dataTwente[tempDewPointTwente, nomatch = 0]
...
#December 22 2015 water on the camera almost whole day
