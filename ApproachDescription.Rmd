...
precipitationTwente[ precipitationDurationPWS > 400 | precipitationDurationElec > 400, rain:=TRUE]
...
Therefore a possibility is to create a binary variable that assesses the presence of rain instead of focusing  on precise measure of rain amount an duration.
...
Also in this case there............FROM HERE ON
...
```{r, ResultsBinaryPrecipitation, dependson=c('TwenteBinaryPrecipitationTrainTree', 'TrainTestDataTwente')}
