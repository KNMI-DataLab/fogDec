...
```{r, trainTestDataTwente ,cache=TRUE, dependson=c('TemperatureDataTwente', 'HumidityDataTwente', 'WindDataTwente', 'dataTwente')}
...
exampleImg2 <- list.files("inst/extdata/cornerCasesTwente/", pattern = "EHTW_201510271350.jpg", full.names = TRUE)
...
exampleImg2 <- list.files("inst/extdata/cornerCasesTwente/", pattern = "EHTW_201509170520.jpg", full.names = TRUE)
example_par <- par(mfrow=c(1,2))
img3 <- lapply(exampleImg2, load.image)
lapply(img3, plot, main = "Objects appearing in the scene: working vehicles in the distance", cex.main = 0.7)
par(example_par)
...
```{r, LookIntoClusters4, cache=FALSE, echo=FALSE}
...
exampleImg2 <- list.files("inst/extdata/cornerCasesTwente/", pattern = "EHTW_201510060700.jpg", full.names = TRUE)
example_par <- par(mfrow=c(1,2))
img3 <- lapply(exampleImg2, load.image)
