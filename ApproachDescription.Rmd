...
```{r, HumidityData, cache=TRUE}
humidityTwente <- ReadHumidityData("inst/extdata/Sensor/DeBilt_RelativeHumidity.csv")
...
trainTwente <- dataTwente[year==2015, .(dateTime, meanEdge, changePoint, smoothness, meanHue,
                meanSaturation, meanBrightness, MOR, foggy, day, month, hour)] #, windSpeed, relHumidity) ]
