...
#model2500<-h2o.loadModel("/home/pagani/nndataH2O/TECO/2500model/dl_grid_model_2")
model7500<-h2o.loadModel("/home/pagani/nndataH2O/TECO/7500model/dl_grid_model_2")
#model2500m<-h2o.loadModel("/home/pagani/nndataH2O/TECO/2500model/dl_grid_model_7")


#perf2500<-h2o.performance(model2500,h2oTestFrame)
#perf2500m<-h2o.performance(model2500m,h2oTestFrame)
perf7500<-h2o.performance(model7500,h2oTestFrame)
...
cm2500<-h2o.confusionMatrix(perf2500)
#cm2500m<-h2o.confusionMatrix(perf2500m)
#cm7500<-h2o.confusionMatrix(perf7500)


#draw_confusion_matrix_binaryH20(cm2500)
#draw_confusion_matrix_binaryH20(cm2500m)
#draw_confusion_matrix_binaryH20(cm7500)
...
# resultsTest7500$prediction<-prediction7500DT$predF1Opt
# 
# library(caret)
# 
