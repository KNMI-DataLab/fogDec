...
\item Training set: +-1100 random fog and +-1100 non-fog pictures from De Bilt,Cabauw,Airports,A4 HM5-HM11 (i.e.,9 cameras) 
...
\item Results:
\begin{itemize}
\item In-sample: \Sexpr{confInSample}
\item Out-of-sample: \Sexpr{confOutSample}
\end{itemize}
