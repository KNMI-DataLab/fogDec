...
```{r sensors_highway}
test11<-trainSet[grepl("^A",samplesTrain2500$camera_description),]
length(unique(test11$KISstations))
#4

test22<-trainSet[grepl("^A",samplesTrain7500$camera_description),]
length(unique(test22$KISstations))
#7
