...
\author[Wauben, Pagani, Roth]{Dr. W. Wauben, Dr. G.A. Pagani, and Dr. M. Roth}
...
\begin{frame}{Experiments of scotland traffic cameras}


\begin{columns}
\column{0.4\textwidth}
\includegraphics[height=3cm]{figure/scotlandOverviewAll}\\
\vspace{0.2cm}
...
\item{Highly dynamic: appearing disappearing objects, change in scenery}
\end{itemize}
\end{itemize}
\end{columns}
...
\begin{frame}{Note on technologies used}
